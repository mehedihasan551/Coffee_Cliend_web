            ...
            <div style={{ backgroundImage: `url(${bgImg})`, height: "100vh", width: "100%" }}>
                <div className=' flex justify-center  '>
                    <div className='  mt-64 ml-96'>
                        ...
                        <div className=' md:ml-56'> <button className="p-3  mt-4 hover:bg-transparent hover:border hover:border-white hover:text-white bg-[#E3B577] font-serif italic font-bold transition duration-4 00 ease-in-out md:ease-in">Learn More</button></div>
                    </div>
                </div>
            </div>
            <div>
